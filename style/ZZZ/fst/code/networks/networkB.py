...
class Network:
    ...
    def build( self , image ):
        ...
        image = image / 255.0
        image_p = reflect_padding( image , pad = 24 )

        conv1 = conv_layer( image_p ,  32 , 9 , 1 , name = 'conv1' )
        ...
        conv_t1 = conv_tranpose_layer( resid3  , 64 , 3 , 2 , name = 'convt1' )
        conv_t2 = conv_tranpose_layer( conv_t1 , 32 , 3 , 2 , name = 'convt2' )

        conv_t3 = conv_layer( conv_t2 , 3 , 9 , 1 , relu = False , name = 'convt3' )
