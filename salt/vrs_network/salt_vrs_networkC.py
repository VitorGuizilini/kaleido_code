...
class vrs( kld.tf.vrs ):
    ...
    def build( self , data ):
        ...
        with tf.variable_scope( 'Layers' ):
            ...
            latent1 = conv(   conv4 , 'latent1' , 256 , [3] , 2 , both , both )
            latent2 = conv( latent1 , 'latent2' , 512 , [3] , 1 , both , both ) + latent1
            latent3 = conv( latent1 , 'latent2' , 512 , [3] , 1 , both , both ) + latent2
            latent4 = conv( latent1 , 'latent2' , 512 , [3] , 1 , both , both ) + latent3

            deconv4 = deconv( latent4 , 'deconv4' , 128 ,   [3] , conv4 , both , both )
